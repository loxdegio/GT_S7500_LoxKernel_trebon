...
enum
{
	...
	KERN_MAX_THREADS=5000,	/* int: Maximum nr of threads in the system */
 	KERN_RANDOM=40,		/* Random driver */
 	KERN_SHMALL=2097152,		/* int: Maximum size of shared memory */
 	KERN_MSGMNI=2048,		/* int: msg queue identifiers */
 	KERN_SEM=43,		/* struct: sysv semaphore limits */
 	KERN_SPARC_STOP_A=44,	/* int: Sparc Stop-A enable */
 	KERN_SHMMNI=4096,		/* int: shm array identifiers */
...
enum
{
	...
	VM_DIRTY_BACKGROUND=35,	/* dirty_background_ratio */
	VM_DIRTY_RATIO=70,	/* dirty_ratio */
	...
	VM_SWAPPINESS=35,	/* Tendency to steal mapped memory */
	VM_LOWMEM_RESERVE_RATIO=20,/* reservation ratio for lower memory zones */
	VM_MIN_FREE_KBYTES=5120,	/* Minimum free kilobytes to maintain */
...
enum
{
	...
	FS_MAXFILE=65536,	/* int:maximum number of filedescriptors that can be allocated */
	FS_DENTRY=8,
